...
class NestEggApi {
  ...
  static async updateUser<Promise>(data: {
    ...
    let res = await this.request(`users/${data.userId}`, data, 'patch');
    return res.user;
  }
  ...
  static async updateSubcategory<Promise>(data: {
    ...
    let res = await this.request(`subcategories/${data.subcategoryId}`, data, 'patch');
    return res.subcategory;
  }
  ...
  static async updateAllocation<Promise>(data: {
    ...
    let res = await this.request(`allocations/${data.allocationId}`, data, 'patch');
    return res.allocation;
  }
