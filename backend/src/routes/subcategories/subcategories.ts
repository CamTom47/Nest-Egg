...
router.get(
	...
	async function (req: CustomRequest<SubcategoryModel>, res: Response, next: Function): Promise<{} | void> {
		try {
...
router.patch(
	"/:subcategory_id",
	ensureCorrectUserOrAdmin,
	async function (req: CustomRequest<SubcategoryModel>, res: Response, next: NextFunction): Promise<{} | void> {
		try {
