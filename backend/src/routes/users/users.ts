...
router.get('/:user_id', ensureCorrectUserOrAdmin, async function(req: CustomRequest<UserModel>, res: Response , next: NextFunction): Promise<{} | void> {
    try {
 ...
 */
  ...
  router.patch('/:user_id', ensureCorrectUserOrAdmin, async function(req: CustomRequest<UserModel>, res: Response, next: NextFunction): Promise<{} | void>{
    try{
 ...
 */
  ...
  router.delete('/:user_id', ensureCorrectUserOrAdmin, async function(req: CustomRequest<UserModel>, res: Response, next: NextFunction): Promise<{} | void>{
    try{
